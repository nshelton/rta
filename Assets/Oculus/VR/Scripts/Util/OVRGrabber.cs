...
public class OVRGrabber : MonoBehaviour
{
    ...
    void OnUpdatedAnchors()
    {
        ...
        m_prevFlex = Mathf.Max(m_prevFlex, OVRInput.Get(OVRInput.Axis1D.PrimaryIndexTrigger, m_controller));
    ...
    Stack<Valve.VR.InteractionSystem.EventButton> m_clickables = new Stack<Valve.VR.InteractionSystem.EventButton>();
